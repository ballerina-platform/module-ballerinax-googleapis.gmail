...
isolated function convertListDraftsResponseToDraftListPage(oas:ListDraftsResponse response)
...
isolated function convertListThreadsResponseToThreadListPage(oas:ListThreadsResponse response) returns ThreadListPage {
...
isolated function convertListHistoryResponseToHistoryListPage(oas:ListHistoryResponse response) returns HistoryListPage {
